...
// qiushao patch
int QTermWidget::getForegroundPID()
{
...
//    m_impl->m_terminalDisplay->setSize(80, 40);
    ...
    //qiushao patch start
    connect(m_impl->m_terminalDisplay->screenWindow()->screen(), &Screen::onNewLine, this, &QTermWidget::onNewLine);
    //qiushao patch end
}
...
{
    m_impl->m_terminalDisplay->screenWindow()->screen()->setSelectionStart(column, row, false);
}
